...
export default function ProductCard({ title, category, image, specs, id }) {
  return (
    <div className="group bg-white rounded-2xl shadow-lg border hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col w-[280px] min-h-[470px] hover:shadow-2xl">
      ...
      <div className="p-6 flex flex-col flex-grow text-[#0b0e19]">
        ...
        <Link
          to={`/products/${id}`}
          className="mt-auto flex items-center justify-center gap-2 bg-red-600 text-white px-5 py-3 rounded-lg text-sm font-bold hover:bg-[#0b0e19] transition-all duration-300"
        >
